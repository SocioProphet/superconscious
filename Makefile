...
m0-schema-fixtures:
	...
	python3 scripts/validate-m0-training-provenance.py tests/fixtures/m0/training-provenance.fully-certified.synthetic.json
	...
	python3 scripts/validate-m0-training-provenance.py tests/fixtures/m0/training-provenance.external-artifact.synthetic.json
...
m1-5-schema-fixtures:
	...
	python3 scripts/validate-m1-5-attribution-graph.py tests/fixtures/m1-5/attribution-graph.bit-exact-replay.synthetic.json
	...
	python3 scripts/validate-m1-5-attribution-graph.py tests/fixtures/m1-5/attribution-graph.manifest-matches-latent-diverges.synthetic.json
	...
	python3 scripts/validate-m1-5-attribution-graph.py tests/fixtures/m1-5/attribution-graph.manifest-diverges.synthetic.json
	...
	! python3 scripts/validate-m1-5-attribution-graph.py tests/fixtures/m1-5/attribution-graph.equal-digests.synthetic.json
